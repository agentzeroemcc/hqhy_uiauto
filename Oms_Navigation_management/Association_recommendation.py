...
#关联推荐
class Association(unittest.TestCase,Interface):
    @classmethod
    def setUpClass(cls):
        """
        :return:
    ...
    def test_New_add(self):
        ...
        test_name = driver.find_element_by_xpath('//*[@id="customId_2"]/td[3]').text #  获取新增产品名称
        # number = driver.find_element_by_xpath('//*[@id="customId_2"]/td[2]').text  #  获取序号
        try:
        ...
        Interface.ass_recommend(self)  #  新添加关联推荐接口
    ...
    def test_edit(self):
        ...
        try:
            ...
            logger.info("Test fail.", format(e))
            homepage.get_windows_img()
        Interface.ass_edit(self)   #   编辑接口测试
    ...
    def test_delete(self):
        ...
        try:
            ...
            homepage.get_windows_img()
        homepage.button_2()   #  点击确认
        Interface.ass_delete(self)    #    删除接口测试
